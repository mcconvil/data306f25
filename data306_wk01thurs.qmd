...
* Reflections: Due Monday by XXX

* Project readings for Week 3

* Will start tackling the projects in earnest next Thursday.
...
Can find your group assignments [here](XXX)
...
* Under the **Bucknell-DATA306-F25** GitHub Organization you currently have 3 repos:
    + `work-username`: Just you and I can access
    + `class-site`: The whole class can access
    + `project-name`: Your team, stakeholder (possibly), and I can access


* For each repo, you should create an `RStudio` Project (with version control). XXX
